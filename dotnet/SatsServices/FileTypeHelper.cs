...
// Type: SatsServices.FileTypeHelper
...
namespace SatsServices
{
  ...
  {
    public static Dictionary<string, ImageFormat> SupportedFormats = new Dictionary<string, ImageFormat>()
    {
      {
        "png",
        ImageFormat.Png
    ...
    public static string GetContentType(string undottedExtension)
    {
      string lower = undottedExtension.ToLower();
      switch (lower)
      {
        case "ai":
        ...
        default:
          return string.Format("application/{0}", (object) lower);
      }
    }
  }
}
